function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}class App extends React.Component {
  ...
  constructor(props) {
    ...
    return (
      ...
      React.createElement("section", { className: "Game" },
...
const Square = props => {
  ...
  return (
    React.createElement("svg", { viewBox: "0 0 120 120", onClick: () => play(index) },
...
const Grid = props => {
  ...
  return (
    React.createElement("svg", { id: "Grid", viewBox: "0 0 180 180" },
    React.createElement("g", null,
    React.createElement("path", { className: animate(1), d: "M 0,60 H 180" }),
    React.createElement("path", { className: animate(2), d: "M 180,120 H 0" }),
    React.createElement("path", { className: animate(3), d: "M 60,180 V 0" }),
...
const Menu = props => {
  ...
  const buildMenu = () => {
    if (winner === human) {
      return (
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' },
        React.createElement("h1", { className: "title" }, "Congrats! You made it!!"),
        React.createElement("hr", null),
        React.createElement("div", null,
        React.createElement("p", { className: "menu-text" }, "Wanna try again?"),
        React.createElement("button", { onClick: token => startGame('X') }, "X"),
      ...
      return (
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' },
        React.createElement("h1", { className: "title" }, "Oops...Sorry!!"),
        React.createElement("hr", null),
        React.createElement("div", null,
        React.createElement("p", { className: "menu-text" }, "Want another chance?"),
        React.createElement("button", { onClick: token => startGame('X') }, "X"),
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
      ...
      return (
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' },
        React.createElement("h1", { className: "title" }, "It was close!"),
        React.createElement("hr", null),
        React.createElement("div", null,
        React.createElement("p", { className: "menu-text" }, "Wanna do better?"),
        React.createElement("button", { onClick: token => startGame('X') }, "X"),
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
      ...
      return (
        React.createElement("section", { id: "Menu", className: showMenu ? 'display' : 'display hidden' },
        React.createElement("h1", { className: "title" }, "Let's play!"),
        React.createElement("hr", null),
        React.createElement("div", null,
        React.createElement("button", { onClick: token => startGame('X') }, "X"),
        React.createElement("button", { onClick: token => startGame('O') }, "O"))));
...
ReactDOM.render(React.createElement(App, null), document.getElementById('tictactoe'));